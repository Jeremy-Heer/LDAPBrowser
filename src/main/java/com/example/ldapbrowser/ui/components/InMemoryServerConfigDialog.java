...
public class InMemoryServerConfigDialog extends Dialog {
  ...
  private void setupLayout() {
    ...
    Span infoText = new Span(
        "This will create a UnboundID In-Memory Directory Server that runs locally and can be used for testing purposes. The server will be automatically configured with the specified settings.");
    infoText.getStyle()
        .set("color", "#666")
        .set("font-size", "14px")

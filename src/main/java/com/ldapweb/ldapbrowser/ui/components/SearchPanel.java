  ...
  private void initializeComponents() {
    ...
    scopeComboBox.setItemLabelGenerator(scope -> {
      switch (scope.intValue()) {
        case 0:
          return "Base (base object only)";
        case 1:
          return "One Level (immediate children)";
        case 2:
          return "Subtree (all descendants)";
        default:
      ...
      for (String attr : attrs) {
        ...
        if (!trimmed.isEmpty()) {
          ...
          if (trimmed.matches("[a-zA-Z0-9\\-\\.\\+]+")) {
            ...
            showError("Invalid attribute name: " + trimmed
                + ". Attribute names should contain only letters, numbers, hyphens, and dots.");
            return;
          }
        }
      }
